<template>
    <el-menu background-color="#343743" text-color="#fff" active-text-color="#409eff" :default-active="$route.path"
        ...
        <el-submenu index="2">
            ...
            <el-menu-item index="/exception"><i class="el-icon-s-tools"></i>异常专案处理<el-badge :value="subList.length" v-if="subList.length"/></el-menu-item>
            <el-menu-item index="/delay"><i class="el-icon-s-tools"></i>延期申请<el-badge :value="delayList.length" v-if="delayList.length"/></el-menu-item>
            <el-menu-item index="/finish"><i class="el-icon-s-tools"></i>完结申请<el-badge :value="finishList.length" v-if="finishList.length"/></el-menu-item>
            <el-menu-item index="/study"><i class="el-icon-s-tools"></i>任务申请<el-badge :value="taskList.length" v-if="taskList.length"/></el-menu-item>
            <el-menu-item index="/caseApply"><i class="el-icon-s-tools"></i>专案类申请<el-badge :value="caseSubList.length" v-if="caseSubList.length"/></el-menu-item>
        </el-submenu>
        ...
        <el-submenu index="5">
            ...
            <el-menu-item index="/user/info"><i class="el-icon-s-tools"></i>消息中心<el-badge :value="logList.length" v-if="logList.length"/></el-menu-item>
