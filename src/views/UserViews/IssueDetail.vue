    ...
    <el-card>
        ...
        <div class="markdown-container">
            ...
            <div class="toc-container">
                <!-- 侧边导航栏（目录） -->
                <div v-for="anchor in titles" :key="anchor" :style="{ padding: `0 0 10px ${anchor.indent * 20}px`, fontSize: `${24-anchor.indent * 4}px` }"
...
<script>
import { deleteReplyLog } from '@/api/log';
